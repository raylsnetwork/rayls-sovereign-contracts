...
1. Open the [Security tab](https://github.com/raylsnetwork/rayls-privacy-contracts/security) of this repository.
...
This policy covers the `rayls-privacy-contracts` repository (the Rayls protocol smart contracts
