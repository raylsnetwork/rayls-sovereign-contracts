...
1. Open the [Security tab](https://github.com/raylsnetwork/rayls-sovereign-contracts/security) of this repository.
...
- The affected contract(s) or component(s), version(s), and configuration.
...
This policy covers the `rayls-sovereign-contracts` repository (the Rayls protocol smart contracts
and their deployment/tooling). Vulnerabilities in other Rayls components should be reported against
