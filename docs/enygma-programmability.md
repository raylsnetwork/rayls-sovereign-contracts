...
## The Solidity part
To execute arbritrary code in a destination Privacy Node, users can specify a list of up to 5 callables per cross transfer. This is what the `crossTransfer` function signature looks like for an Enygma token contract:
