...
task('tokens:erc721:check-resource-id', 'Checks the resource Id of a token on the Privacy Node')
  ...
  .setAction(async (taskArgs, hre) => {
    ...
    const token = await hre.ethers.getContractAt('RaylsErc721Example', taskArgs.contract, signer);
