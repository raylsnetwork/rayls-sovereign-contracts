...
task('dvp:enygma:erc721:cancel', 'Cancel swap of Enygma token for ERC721 token')
    .addParam(
        'pn',
    ...
    .setAction(async (taskArgs, hre) => {
        ...
        try {
            ...
            const tx = await enygmaToken.cancelERC721Swap(taskArgs.sharedId, taskArgs.chainId, taskArgs.nftId, taskArgs.nftResourceId, taskArgs.amount);
            await tx.wait(1);
