...
describe("ParticipantStorage", function () {
    ...
    beforeEach(async function () {
        ...
        participantStorage = await upgrades.deployProxy(ParticipantStorage, [
            owner,                       // Owner address
            participantManager.target,   // ParticipantManager address
            enygmaManager.target,        // EnygmaManager address
            broadcastManager.target      // BroadcastManager address
        ]);
    ...
    /*it("Should broadcast participants via ParticipantStorage", async function () {
        ...
        // Get the event and validate the transmitted data
