...
/**
 * @title Security Test: RaylsErc721DvpHandler Access Control
 ...
 * - Could unlock tokens, complete swaps, cancel swaps without authorization
 *
 ...
 */
contract RaylsErc721DvpHandlerAccessControlTest is Test {
    Erc721DvpExample public token;
    ...
    function test_cancelSwap_attackerReverts() public {
        ...
        token.cancelSwap(bytes32(0), 1, 1, 100, bytes32(0));
    }
