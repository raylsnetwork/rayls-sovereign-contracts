...
import './EnygmaJoinSplitVerifier.sol';
import {RaylsAccessManaged} from '../../../privateHub/AccessControl/RaylsAccessManaged.sol';

contract EnygmaJoinSplitVerifierProxy is RaylsAccessManaged {
    ...
    function verifyProof(uint[2] calldata _pA, uint[2][2] calldata _pB, uint[2] calldata _pC, uint[34] calldata _pubSignals) public view returns (bool) {
        return EnygmaJoinSplitVerifier(verifierAddress).verifyProof(_pA, _pB, _pC, _pubSignals);
    }
