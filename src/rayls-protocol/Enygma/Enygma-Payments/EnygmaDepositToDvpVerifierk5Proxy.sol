...
import './EnygmaDepositToDvpVerifierk5.sol';
import {RaylsAccessManaged} from '../../../privateHub/AccessControl/RaylsAccessManaged.sol';

contract EnygmaDepositToDvpVerifierk5Proxy is RaylsAccessManaged {
    ...
    function verifyProof(uint[2] calldata _pA, uint[2][2] calldata _pB, uint[2] calldata _pC, uint[43] calldata _pubSignals) public view returns (bool) {
        return EnygmaDepositToDvpVerifierk5(verifierAddress).verifyProof(_pA, _pB, _pC, _pubSignals);
    }
