...
import './EnygmaVerifierk3.sol';
import {RaylsAccessManaged} from '../../../privateHub/AccessControl/RaylsAccessManaged.sol';

contract EnygmaVerifierk3Proxy is RaylsAccessManaged {
    ...
    function verifyProof(uint[2] calldata _pA, uint[2][2] calldata _pB, uint[2] calldata _pC, uint[26] calldata _pubSignals) public view returns (bool) {
        return EnygmaVerifierk3(verifierAddress).verifyProof(_pA, _pB, _pC, _pubSignals);
    }
